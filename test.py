...
class CrosswordCreator():
    ...
    def backtrack(self, assignment):
        ...
        for value in self.order_domain_values(var, assignment):
            assignment_check = copy.deepcopy(assignment)
            assignment_check.update({var : value})
            print(var)
            print(value)
            print(assignment_check)
            print(self.consistent(assignment_check))
            if self.consistent(assignment_check):
